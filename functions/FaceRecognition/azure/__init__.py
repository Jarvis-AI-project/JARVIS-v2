...
# https://www.c-sharpcorner.com/article/face-detection-and-recognition-with-azure-cognitive-services/
# https://stackoverflow.com/questions/72776677/azure-face-service-invalid-request-api-error-on-running-quickstart-code
# https://stackoverflow.com/questions/60325360/azure-cognitiveservices-vision-face-models-models-py3-apierrorexception-inval
# https://www.youtube.com/watch?v=EPGJV5cQbng
# https://github.com/furqan4545/Azure_facial_recognition_module
...
KEY = "a4fd5f939a4e40829f48af3b4d4e7716"

# This endpoint will be used in all examples in this quickstart.
ENDPOINT = "https://jarvis-faceapi.cognitiveservices.azure.com/"
...
woman_images = ["https://csdx.blob.core.windows.net/resources/Face/Images/Family1-Mom1.jpg",
                "https://csdx.blob.core.windows.net/resources/Face/Images/Family1-Mom2.jpg"]
man_images = ["https://csdx.blob.core.windows.net/resources/Face/Images/Family1-Dad1.jpg",
              "https://csdx.blob.core.windows.net/resources/Face/Images/Family1-Dad2.jpg"]
child_images = ["https://csdx.blob.core.windows.net/resources/Face/Images/Family1-Son1.jpg",
                "https://csdx.blob.core.windows.net/resources/Face/Images/Family1-Son2.jpg"]
...
for image in child_images:
    ...
    for face in detected_faces:
        if face.face_attributes.quality_for_recognition != QualityForRecognition.high:
            ...
            break
        face_client.person_group_person.add_face_from_url(
            PERSON_GROUP_ID, child.person_id, image)
        print("face {} added to person {}".format(
            face.face_id, child.person_id))
    if not sufficientQuality:
        continue
